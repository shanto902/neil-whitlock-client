  ...
  return (
    <PaddingContainer className=" relative mt-16">
      ...
      <div className="md:max-h-screen ">
        <div className=" lg:max-h-[82dvh] ">{children}</div>
        <div className=" mt-1">
          <CarouselSlide photos={photos} params={params} />
        </div>
      </div>

      <div className="mb-10 mx-auto py-0 pt-5 lg:pt-10 text-center text-white text-sm font-semibold text-pretty leading-[35px] tracking-widest">
